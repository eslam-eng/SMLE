...
namespace SLIM\Category\App\Providers;
...
use SLIM\Category\Repository\CategoryRepository;
...
class CategoryServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(CategoryServiceInterfaces::class, CategoryService::class);
