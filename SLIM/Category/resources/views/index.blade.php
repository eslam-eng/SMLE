        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col" style="margin-left:1170px">
                    <h2 class="page-title">
                        <a  class="btn btn-danger" href="#" data-bs-toggle="modal" data-bs-target="#modal-add-category">
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="row row-cards">
                <h5>Classification Page</h5>
                <div class="col-12">
                    <form class="card">
                        <div class="card-body">
                            <h3 class="card-title">Filter Classification</h3>
                            <div class="row row-cards">
                                <div class="col-md-6">
                                    <div class="mb-3">
...
{{--                                        <input type="color" class="form-control" placeholder="Name" id="category_color">--}}
{{--                                    </div>--}}
{{--                                </div>--}}
                                <div class="col-md-6">
                                    <div class="mb-3">
...
@endsection
@push('js')
    <script src="{{Module::asset('category:js/app.js')}}" defer></script>
@endpush
