                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="question"
                                                placeholder="Question Title" value="{{ $question->question }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row row-cards">
                                            ...
                                            <select class="form-control specialization" name="specialist_id">
                                                ...
                                                @foreach ($specializations as $specialization)
                                                    <option value="{{ $specialization->id }}"
                                                        {{ $specialization->id == $question->specialist_id ? 'selected' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control sub-specialization" name="sub_specialist_id">
                                                ...
                                                @foreach ($subSpecializations as $subSpecialization)
                                                    <option value="{{ $subSpecialization->id }}"
                                                        {{ $subSpecialization->id == $question->sub_specialist_id ? 'selected' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="abbreviations[]" multiple select2>
                                                ...
                                                @foreach($abbreviations as $abbreviation)
                                                    ...
                                                    @if(in_array($abbreviation->id,$Selected_abbreviations)) selected @endif
                                                    >{{$abbreviation->char_abbreviations}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="level">
                                                ...
                                                <option value="3" {{$question->level == 3 ?'selected' :''}}>Difficult</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
