        ...
        <div class="page-body">
            <div class="container-xl">
                <div class="row row-cards">
                    <h5>Correct Answers Suggestions</h5>
                    <div class="col-12">
                        <form class="card">
                            <div class="card-body">
                                <h3 class="card-title">Filter Suggestions</h3>
                                <div class="row row-cards">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control specialization" name="sub_specialist_id"
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            @include('question::question_suggest.partial')
...
@endsection
@push('js')
    <script src="{{ Module::asset('question_suggest:js/app.js') }}" defer></script>
@endpush
