        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col" style="margin-left:1170px">
                    <h2 class="page-title">
                        <a  class="btn btn-danger" href="#" data-bs-toggle="modal" data-bs-target="#modal-add-permission">
...
@endsection
@push('js')
    <script src="{{Module::asset('permission:js/app.js')}}" defer></script>
@endpush
