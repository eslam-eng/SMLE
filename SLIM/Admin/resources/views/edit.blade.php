        ...
        <div class="page-body">
            <div class="container-xl">
                <div class="row row-cards">
                    <div class="col-12">
                        <form class="card" id="updateForm" action="{{route('admin.update',$admin->id)}}">
                            @csrf
                            {{method_field('PUT')}}
                            <div class="card-body">
                                ...
                                <div class="row row-cards">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="hidden" class="form-control" name="id" placeholder="Name" value="{{$admin->id}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row row-cards">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="is_active">
                                                ...
                                                <option value="0" {{!$admin->is_active ?'selected':''}}>In Active</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
