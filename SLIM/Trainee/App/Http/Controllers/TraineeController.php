...
class TraineeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $trainees = $this->traineeService->with(['sub_specialist', 'specialist'])->getAllPaginated($request->all(), 15);
    ...
    {
        $quizes = Quiz::where('trainee_id', $trainee->id)->paginate(10);
        return view('trainee::show', compact('trainee', 'quizes'));
    }
