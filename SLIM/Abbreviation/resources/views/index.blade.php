                            ...
                            <div class="row row-cards">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Abbreviations Chars" id="chars">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">Abbreviations Words</label>
                                        <input type="text" class="form-control" placeholder="Abbreviations Words" id="words">
                                    </div>
                                </div>
